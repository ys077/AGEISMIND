...
from app.schemas.risk_heatmap import HeatmapResponse, DistrictHeatmapResponse
...
def get_heatmap_candidates(complaint_id: str, db: Session = Depends(get_db)):
    return risk_heatmap_service.get_heatmap_candidates(complaint_id, db)
